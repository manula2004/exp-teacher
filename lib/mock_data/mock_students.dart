...
final List<StudentModel> _allStudents = [
  ...
  const StudentModel(
    ...
    classId: 'cls-003',
    name: 'Karl Bergmann',
    performancePercent: 66,
  ),
  const StudentModel(
    id: 'S213',
    classId: 'cls-003',
    name: 'Grace O\'Sullivan',
    performancePercent: 59,
  ),
  const StudentModel(
    id: 'S214',
    classId: 'cls-003',
  ...
  const StudentModel(
    ...
    classId: 'cls-005',
    name: 'Elsa Lindqvist',
    performancePercent: 57,
  ),
  const StudentModel(
    id: 'S414',
    classId: 'cls-005',
    name: 'Theo Baumann',
    performancePercent: 51,
  ),
  const StudentModel(
    id: 'S415',
    classId: 'cls-005',
  ...
  const StudentModel(
    ...
    classId: 'cls-006',
    name: 'Luca Romano',
    performancePercent: 53,
  ),
  const StudentModel(
    id: 'S515',
    classId: 'cls-006',
    name: 'Abby Chen',
    performancePercent: 47,
  ),
